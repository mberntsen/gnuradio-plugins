...
import sip
from decoders import encoder_impuls
from grc_gnuradio import blks2 as grc_blks2
import protocols
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for a in range(5):
          ...
          _variable_qtgui_push_button_0_push_button.pressed.connect(partial(self.button_0_pressed, 1 << (4-a)))
          ...
          _variable_qtgui_push_button_1_push_button.pressed.connect(partial(self.button_1_pressed, 1 << (4-a)))
        ...
        self.encoder = encoder_impuls(samp_rate)
        ...
        #self.connect((self.blocks_multiply_xx_0, 0), (self.file_sink_0, 0))
    ...
    def button_0_pressed(self, btn):
        self.encoder.code = str(protocols.protocol_impuls(17, btn, 0, 1))
    ...
    def button_1_pressed(self, btn):
        self.encoder.code = str(protocols.protocol_impuls(17, btn, 1, 0))
        self.encoder.start_sending()
...
def main(top_block_cls=top_block, options=None):
    #a = protocols.protocol_impuls(17, 1, 0, 1)
    #print a
    #exit()
