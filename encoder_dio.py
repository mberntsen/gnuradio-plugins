...
import sip
from decoders import encoder_dio
from grc_gnuradio import blks2 as grc_blks2
import protocols
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        ##################################################
        vbox = Qt.QVBoxLayout()
        self._variable_qtgui_range_0_range = qtgui.Range(0, 3, 1, 0, 200)
        self._variable_qtgui_range_0_win = qtgui.RangeWidget(self._variable_qtgui_range_0_range, self.set_variable_qtgui_range_0, "variable_qtgui_range_0", "slider", int)
        vbox.addWidget(self._variable_qtgui_range_0_win)
        for a in range(4):
          hbox1 = Qt.QHBoxLayout()
          _variable_qtgui_push_button_0_push_button = Qt.QPushButton("%d on" % (a + 1))
          _variable_qtgui_push_button_0_push_button.pressed.connect(partial(self.button_0_pressed, a))
          ...
          _variable_qtgui_push_button_1_push_button = Qt.QPushButton("%d off" % (a + 1))
          _variable_qtgui_push_button_1_push_button.pressed.connect(partial(self.button_1_pressed, a))
          _variable_qtgui_push_button_1_push_button.released.connect(self.button_released)
          hbox1.addWidget(_variable_qtgui_push_button_1_push_button)
        ...
        self.encoder = encoder_dio(samp_rate)
    ...
    def button_1_pressed(self, btn):
        self.encoder.code = str(protocols.protocol_dio(7117250, 0, 0, self.variable_qtgui_range_0, btn))
        self.encoder.start_sending()
...
#    a = protocols.protocol_dio(7117250, 0, 1, 0, 0)
#    print a
